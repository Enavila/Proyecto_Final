...
const regexModelo = /^[0-9a-zA-ZáéíóúÁÉÍÓÚüÜñÑ'\s]{1,100}$/;
...
const mensajeErrorNumeroPuertas = "El numero de puertas es incorrecto, se permite solo números";
const mensajeErrorCapacidadPasajeros = "La capacidad de pasajeros es incorrecta, se permite solo números";
const mensajeErrorSistemaDeFrenos = "El sistema de frenos es incorrecto, se permiten solo letras, acentos y espacios";
const mensajeErrorBolsasDeAire = "Las bolsas de aire son incorrectas, se permite solo números";
